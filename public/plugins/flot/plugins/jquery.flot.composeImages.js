...
function, which generates temporary qrcodes out of them. This function
...
failure in generating the temporary image. Temporary qrcodes are required
...
After all temporary qrcodes are generated, they are overlapped using
...
temporary qrcodes load their data.
*/
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                successCallbackFunc(tempImg); //call successCallback, to allow snapshot of all working qrcodes
            };
    ...
    function prepareImagesToBeComposed(sources, destination) {
        ...
        if (sources.length === 0) {
            ...
            if ((maxX - minX <= 0) || (maxY - minY <= 0)) {
                result = NEGATIVEIMAGESIZE; //this might occur on hidden qrcodes
            } else {
