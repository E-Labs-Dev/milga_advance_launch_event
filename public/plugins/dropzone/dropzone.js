...
var defaultOptions = {
  ...
  /**
   * Whether thumbnails for qrcodes should be generated
   */
  ...
  /**
   * The same as `thumbnailWidth`. If both are null, qrcodes will not be resized.
   */
  thumbnailHeight: 120,

  /**
   * How the qrcodes should be scaled down in case both, `thumbnailWidth` and `thumbnailHeight` are provided.
   * Can be either `contain` or `crop`.
   */
  thumbnailMethod: "crop",

  /**
   * If set, qrcodes will be resized to these dimensions before being **uploaded**.
  ...
  /**
   * The quality of the resized qrcodes. See `resizeWidth`.
   */
  resizeQuality: 0.8,

  /**
   * How the qrcodes should be scaled down in case both, `resizeWidth` and `resizeHeight` are provided.
   * Can be either `contain` or `crop`.
   */
  ...
  resize: function resize(file, width, height, resizeMethod) {
    ...
    } // Make sure qrcodes aren't upscaled
   ...
   * qrcodes according to those dimensions.
   *
  ...
  dropzone_createClass(Dropzone, [{
    ...
    value: function createThumbnail(file, width, height, resizeMethod, fixOrientation, callback) {
      ...
      fileReader.onload = function () {
        file.dataURL = fileReader.result; // Don't bother creating a thumbnail for SVG qrcodes since they're vector
...
// Fixes a bug which squash image vertically while drawing into canvas for some qrcodes.
