                                ...
                                <div class="tab-pane  active" id="agenda1">
                                    ...
                                    <div class="line-div">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <span>
                                                    <img class="main-layer" src="{{ asset('images/microphone.png') }}">
                                    ...
                                    <div class="line-div">
                                        <ul>
                                            ...
                                            <li class="border"></li>
                                            <li>
                                                Announcement of first clinical trial results comparing Oral Benfotiamine Vs
                                                IM Thiamine
                                                <span>
                                                    <img class="main-layer" src="{{ asset('images/microphone2.png') }}">
